...
def get_generation_parser(interactive=False, default_task="translation", default_world_size=1):
    parser = get_parser("Generation", default_task)
    add_dataset_args(parser, gen=True)
    add_distributed_training_args(parser, default_world_size=default_world_size)
